...
function Strategy(options, verify) {
  ...
  if(options.special === 'intercom') {
    this._oauth2.getOAuthAccessToken = function(code, params, callback) {
      ...
      console.log('encoding', params['app_id'] + ":" + params['client_id']);
      console.log('encoded', new Buffer(params['app_id'] + ":" + params['client_id']).toString('base64'));

      console.log('getaccesstoken', this._getAccessTokenUrl());
      console.log('post_headers', post_headers);
