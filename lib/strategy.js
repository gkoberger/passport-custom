...
function Strategy(options, verify) {
  ...
  if(options.special === 'intercom') {
    ...
    this._oauth2.getOAuthAccessToken = function(code, params, callback) {
      ...
      params['client_id'] = this._clientId;
      params['client_secret'] = this._clientSecret;
      params['app_id']= options.other.app_id;
      params['code']= code;
      ...
      var post_headers= {
        ...
        "Authorization": "Basic " + new Buffer(params['app_id'] + ":" + options.other.api_key).toString('base64'),
      };
    ...
    this.userProfile = function(accessToken, done) {
      ...
      var req_options = {
        url: this._userProfileURL + "?" + post_data,
        json: true,
        auth: {
          user: accessToken,
          pass: '',
      ...
      console.log('intercomtest', '========================');
      console.log('intercomtest', 'url', req_options);
      console.log('intercomtest', 'accessToken:', accessToken);
      console.log('intercomtest', '========================');
...
Strategy.prototype.userProfile = function(accessToken, done) {
  var temp_url = this._userProfileURL;
  ...
  this._oauth2.get(this._userProfileURL, accessToken, function (err, body, res) {
    ...
    if (err) {
      console.log('======================');
      console.log('OAUTH9 url', temp_url);
      console.log('OAUTH9 accesstoken', accessToken);
      console.log('OAUTH9 error', err);
      console.log('======================');
